...
export default function PolitikaNewsGrid() {
  ...
  if (!newsList.length)
    return (
      <div className="text-center py-10 text-lg text-gray-600 dark:text-gray-300">
        Politika kategorisinde haber bulunamadı.
      </div>
    );

  return (
    <section className="container mx-auto px-2">
      <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Politika Haberleri</h2>
        ...
        {newsList.map((item) => (
          ...
          >
            <Link href={`/haber/${item.id}`}>
              ...
              <div className="inline-block mt-3 px-2 py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 rounded text-xs font-semibold">
                Politika
              </div>
            </Link>
          </article>
