...
export default function EgitimNewsGrid() {
  ...
  if (!newsList.length)
    return (
      <div className="text-center py-10 text-lg text-gray-600 dark:text-gray-300">
        Eğitim kategorisinde haber bulunamadı.
      </div>
    );

  return (
    <section className="container mx-auto px-2">
      <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Eğitim Haberleri</h2>
        ...
        {newsList.map((item) => (
          ...
          >
            <Link href={`/haber/${item.id}`}>
              ...
              <div className="inline-block mt-3 px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded text-xs font-semibold">
                Eğitim
              </div>
            </Link>
          </article>
