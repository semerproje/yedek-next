// Profesyonel Son Dakika Haberleri Ekleme Scripti
import { initializeApp } from 'firebase/app';
import { getFirestore, collection, addDoc, Timestamp } from 'firebase/firestore';

// Firebase config - Update these with your actual config
...
async function addProfessionalBreakingNews() {
  try {
    ...
    console.log('🔥 Bu haberler "breaking: true" olarak işaretlenmiştir ve BreakingNewsBar\'da görünecektir.');
...
export { addProfessionalBreakingNews };
